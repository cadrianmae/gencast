"""Bridge between AudioSegment and numpy arrays.

Minimal helper functions for converting between pydub AudioSegment and float32 numpy arrays.
Lifted from scratch/spatial_test.py:197-225.
"""
